...
.. code-block:: console
    ...
    GITHUB_ACCESS_TOKEN=<github_acess_token> PYTHONPATH=. pipenv run src_ops_metrics/cli.py --project <project_name> -v True
...
.. code-block:: console
    ...
    GITHUB_ACCESS_TOKEN=<github_acess_token> PYTHONPATH=. pipenv run src_ops_metrics/cli.py --project <project_name> -r True
