...
"""Thoth SLI/SLO metrics class used only for Load/Save operations."""

from srcopsmetrics.entities.thoth_metrics import ThothMetrics


class ThothSliSlo(ThothMetrics):
    """Metrics class for Kebechet SLI/SLO indicators for each manager."""
